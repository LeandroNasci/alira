    ...
    <div id="page-about-payments" className="container">
      ...
      <div className="about-payments-content">
        ...
        <div className="payments">
          ...
          <p className="first">Olá! O pagamento do nosso site é realizado de maneira segura por meio da plataforma do <em>PagSeguro</em>. As formas de pagamento são:</p>
          <img src={moneyImg} alt="Logo PagSeguro"/>
          <ul>
            <li><b>Cartão de crédito</b> (Pode ser dividido em várias parcelas);</li>
            <li><b>Boleto bancário</b> (Leva até 3 dias úteis para compensação).</li>
          </ul>
          <br />
          <p>A compra é finalizada no site do <em>PagSeguro</em> (fique tranquilo), no qual você será direcionado após o preenchimento dos seus dados no site da Alira. Depois de concluído você receberá um e-mail de confirmação do seu pagamento.</p>
        </div>

        <div className="shipping">
          <h2>ENVIO DE PRODUTOS</h2>
          <p className="first">Para que os produtos cheguem até você, nós utilizamos o Envio Fácil, que é uma parceria do <em>PagSeguro</em> com os <em>Correios</em> e disponibiliza duas formas de envio, ambas com opção de rastreio:</p>
